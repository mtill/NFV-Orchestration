...
public class VNFAvailableCapacityExceeded extends VNFEvaluationMetric {
	
	final CoordVNF_SVNF_Algorithm SVNF;
	
	public VNFAvailableCapacityExceeded(CoordVNF_SVNF_Algorithm SVNF) {
		this.SVNF = SVNF;
	}
	...
	public Double calculate(
		...
		return (double) this.SVNF.availableCapacityExceeded;
	}
